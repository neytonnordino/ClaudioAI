  ...
  return (
    <header className="bg-[#212121] py-1 border-b-1 border-white/3 w-full z-10 absolute top-0 left-0 right-0">
      <div className="flex justify-between items-center w-full text-white px-3">
        ...
        <button className="flex gap-2 items-center cursor-pointer hover:bg-white/10 group p-2 rounded-md transition-all">
          ...
          <div
            ...
            className={`hidden ${isShown ? "hidden" : "inline-flex"}`}
          >
            <LogOut />
          </div>
        </button>
