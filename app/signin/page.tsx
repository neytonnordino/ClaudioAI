...
const SignInPage = async () => {
  ...
  return (
    <div className="fixed w-full h-full left-0 top-0 bg-black/90 text-white flex items-center justify-center z-50">
      <div className="bg-neutral-800 shadow-gray-200 w-72 h-auto md:w-96 md:h-auto flex flex-col border border-white/10 justify-center items-center rounded-lg">
